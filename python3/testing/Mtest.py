...
start = time.clock()
file = open('resultMTest.txt', 'a')
read_k = open('./data/Test data/MTest/kVal.txt')
k = int(read_k.readline())

B = ''
read = 0
read_text = open('./data/Test data/MTest/text.fa', 'r')
...
if (m > 999):
    s = str(n)+'\t'+str(m)+'\t'+str(k)+'\t'+str(round(end - start))+'\t'+\
